...
def Stem(input):
    ...
    net_right = slim.conv2d(net,96,[3,3],padding="VALID",scope="RightConv1")
    ...
    net_left = slim.conv2d(net,192,[3,3],padding="VALID",scope="LeftConv2")
    net_right = slim.max_pool2d(net,[3,3],scope="RightMaxpool1")
...
def avg_pool(input):
    output = slim.avg_pool2d(input,[8,8])
    return output
